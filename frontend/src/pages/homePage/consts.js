...
export const whyStitch = {
    buyers: [
        ...
        { image: "https://res.cloudinary.com/dgxa9gpta/image/upload/v1602103050/homepage/jacket_zhjiqg.svg", title: 'PERSONAL TOUCH', text: 'When creating a custom wardrobe, you can personalize everything from the choice of swatch, to the buttons and pockets style, lining color, and even lapel width. All of your garments are created based on your specific preferences, swatch selection and style.' },
        { image: "https://res.cloudinary.com/dgxa9gpta/image/upload/v1602103050/homepage/pig_f98ptj.svg", title: 'AFFORDABILITY', text: 'When creating a custom wardrobe, you can personalize everything from the choice of swatch, to the buttons and pockets style, lining color, and even lapel width.All of your garments are created based on your specific preferences, swatch selection and style.' }
    ],
    talents: [
        ...
        { image: "https://res.cloudinary.com/dgxa9gpta/image/upload/v1602103050/homepage/world_s54efo.svg", title: 'Build Your Brand', text: 'When creating a custom wardrobe, you can personalize everything from the choice of swatch.' },
